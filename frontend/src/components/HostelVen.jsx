...
const HostelVen = ({ onHostelData }) => {
  ...
  return (
     <>
       ...
       <hr/>
       <MDBInput label="Warden Present" value={wardenPresent} onChange={(e) => setWardenPresent(e.target.value)} /><hr/>
       <MDBInput label="No of Wardens" value={noOfWardens} onChange={(e) => setNoOfWardens(e.target.value)} /><hr/>
       <MDBInput label="Food Included" value={foodIncluded} onChange={(e) => setFoodIncluded(e.target.value)} /><hr/>
       <MDBInput label="Longitude" value={longitude} onChange={(e) => setLongitude(e.target.value)} /><hr/>
       <MDBInput label="Latitude" value={latitude} onChange={(e) => setLatitude(e.target.value)} /><hr/>
       <MDBInput label="Security Present" value={securityPresent} onChange={(e) => setSecurityPresent(e.target.value)} /><hr/>
       <MDBInput label="For Gender" value={forGender} onChange={(e) => setForGender(e.target.value)} /><hr/>
       <MDBInput label="Rules" value={rules} onChange={(e) => setRules(e.target.value)} /><hr/>
